...
import { CreateCompany } from './../../../../helpers/apis/Company';
...
const Create = () => {
    ...
    const save = async (e) => {
        ...
        if (name == "" || number == "" || color == "" || year == "" || places == ""|| model== "") {
            ...
            const response = await CreateCompany(object);
            if (response.statusCode == 200) {
                setOk(true);
            } else if (response.statusCode == 409) {
                await setMessage("El número de unidad ya se encuentra registrado a otra unidad")
                setError(true);
            }
            else {
                await setMessage("Ocurrió un error al intentar guardar la unidad, contacte al soporte técnico")
                setError(true);
            }
        }
    };
                            ...
                            <div className="px-4 py-5 sm:p-6">
                                <form className="space-y-8 divide-y divide-gray-200" onSubmit={save}>
                                    <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                                        <div>
                                            <div>
                                                <h3 className="text-lg leading-6 font-medium text-gray-900">Nueva Unidad</h3>
                                                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                                    Rellena la información para crear una nueva unidad
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                La unidad ha sido guardado con éxito
                                            </p>
                                        </div>
                                    </div>
                                </div>
