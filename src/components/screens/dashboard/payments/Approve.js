...
import { ApprovePayment, GetOnePayment } from "../../../../helpers/apis/Payment";
...
const Approve = (props) => {
  ...
  const update = async (e) => {
    e.preventDefault();
      ...
      const response = await ApprovePayment(object);
      if (response.statusCode == 200) {
        ...
        await setMessage(
          "Ocurrió un error al intentar approvar el pago, contacte al soporte técnico"
        );
        setError(true);
      }
  };
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        El pago ha sido aprobado con éxito
                      </p>
                    </div>
                  </div>
                </div>
