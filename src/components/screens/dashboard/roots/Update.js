...
import { UpdateRoot, GetOneRoot } from '../../../../helpers/apis/Root';
...
const Update = (props) => {
    ...
    useEffect(() => {
        const request = async () => {
            const response = await GetOneRoot(props.id);
    ...
    const update = async (e) => {
        ...
        if (name == "" || username == "") {
            ...
            const response = await UpdateRoot(object);
            if (response.statusCode == 200) {
                setOk(true);
                ...
                await setMessage("Ocurrió un error al intentar actualizar el super administrador, contacte al soporte técnico")
                setError(true);
            }
        }
    };
                            ...
                            <div className="px-4 py-5 sm:p-6">
                                <form className="space-y-8 divide-y divide-gray-200" onSubmit={update}>
                                    <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                                        <div>
                                            <div>
                                                <h3 className="text-lg leading-6 font-medium text-gray-900">Editar super administrador</h3>
                                                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                                    Rellena la información para actualizar el super administrador
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                El super administrador ha sido actualizado con éxito
                                            </p>
                                        </div>
                                    </div>
                                </div>
