...
import { GetOneHelper, UpdateHelper } from './../../../../helpers/apis/Helper';
...
const Update = (props) => {
    ...
    useEffect(() => {
        const request = async () => {
            const response = await GetOneHelper(props.id);
    ...
    const update = async (e) => {
        ...
        if (name == "" || phone == "") {
            ...
            const response = await UpdateHelper(object);
            if (response.statusCode == 200) {
                setOk(true);
            } else if (response.statusCode == 409) {
                setMessage("el numero de telefono  ya se encuentra asignado a un colector")
                setError(true);
            }
            else {
                setMessage(" Ocurrió un error al intentar actualizar el colector, contacte al soporte técnico")
                setError(true);
            }
        }
    };
                            ...
                            <div className="px-4 py-5 sm:p-6">
                                <form className="space-y-8 divide-y divide-gray-200" onSubmit={update}>
                                    <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                                        <div>
                                            <div>
                                                <h3 className="text-lg leading-6 font-medium text-gray-900">Editar colector</h3>
                                                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                                    Rellena la información para actualizar el colector
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="pt-5">
                                        <div className="flex justify-end">
                                            <button
                                                onClick={() => {
                                                    navigation.push("/dashboard/helpers");
                                                }}
                                                type="button"
                            ...
                            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                El colector ha sido actualizado con éxito
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-5 sm:mt-6">
                                    <button
                                        ...
                                        onClick={async () => { await setOk(false); navigation.push('/dashboard/helpers'); }}
                                    >
                                        Aceptar
                                    </button>
                                </div>
