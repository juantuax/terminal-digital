...
const Helpers = () => {
  ...
  const Delete = async () => {
    const response = await DeleteHelper(HelperId);
    if (response.statusCode == 200) {
      const request = async () => {
        const response = await GetAllHelpers();
        if (response.statusCode == 200) {
  ...
  const Active = async () => {
    const response = await ActiveHelper(HelperId);
    if (response.statusCode == 200) {
      const request = async () => {
        const response = await GetAllHelpers();
        if (response.statusCode == 200) {
  ...
  const FilterActive = (text) => {
    const result = Helpers.filter((item) =>
  ...
  const currentPosts = Helper.slice(indexOfFirstPost, indexOfLastPost);
                              ...
                              {rol != 1 && (
                                <td className="whitespace-nowrap">
                                  <div className="relative flex flex-wrap items-center ">
                                    <Link
                                      style={{ marginLeft: 10 }}
                                      to={`/dashboard/Helpers/${person.id}`}
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Esta seguro que desea Activar el colector?
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Esta seguro que desea Eliminar el colector?
                      </p>
                    </div>
                  </div>
                </div>
