...
import { UploadFile } from './../../../../helpers/apis/File';
    ...
    const save = async (e) => {
        ...
        if (name == "" || password == "" || confirm == "" || phone == "") {
            ...
            if (response.statusCode == 200) {
                ...
                setMessage("Existe un colector con el número de teléfono asignado")
                setError(true);
            }
            else {
                setMessage(" Ocurrió un error al intentar guardar el colector, contacte al soporte técnico")
                setError(true);
            }
        }
    };
                            ...
                            <div className="px-4 py-5 sm:p-6">
                                <form className="space-y-8 divide-y divide-gray-200" onSubmit={save}>
                                    <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                                        <div>
                                            <div>
                                                <h3 className="text-lg leading-6 font-medium text-gray-900">Nuevo colector</h3>
                                                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                                    Rellena la información para crear un nuevo colector
                                                </p>
                                            </div>
                                        </div>
                                                ...
                                                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                                    ...
                                                    <div className="mt-1 sm:mt-0 sm:col-span-2">
                                                        <input
                                                            ...
                                                            onChange={(e) => { setPhone(e.target.value); setPassword(e.target.value); setConfirm(e.target.value) }}
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                El colector ha sido guardado con éxito
                                            </p>
                                        </div>
                                    </div>
                                </div>
