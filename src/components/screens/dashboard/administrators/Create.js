...
const Create = () => {
  ...
  const save = async (e) => {
    e.preventDefault();
    if (name == "" || username == "" || confirm == "" || password == "") {
      setEmpty(true);
    } else {
      const object = {
        fullname: name,
      ...
      if (response.statusCode == 200) {
        ...
        await setMessage("El usuario ya se encuentra asignado a una terminal");
        setError(true);
      } else {
        await setMessage(
          "Ocurrió un error al intentar guardar la terminal, contacte al soporte técnico"
        );
        setError(true);
      }
    }
                    ...
                    <div>
                      <div>
                        ...
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">
                          Rellena la información para crear una nueva terminal
                        </p>
                      </div>
                    </div>
