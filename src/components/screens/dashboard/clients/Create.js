...
import { CreateClient } from './../../../../helpers/apis/Client';
...
const Create = () => {
    ...
    const save = async (e) => {
        ...
        if (name == "" || codeClient == "") {
            ...
            const response = await CreateClient(object);
            if (response.statusCode == 200) {
                setOk(true);
            } else if (response.statusCode == 409) {
                await setMessage("El codigo del cliente ya se encuentra registrado a otro cliente")
                setError(true);
            }
            else {
                await setMessage("Ocurrió un error al intentar guardar el cliente, contacte al soporte técnico")
                setError(true);
            }
        }
    };
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                                    Rellena la información para crear un nuevo cliente
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                El cliente ha sido guardado con éxito
                                            </p>
                                        </div>
                                    </div>
                                </div>
